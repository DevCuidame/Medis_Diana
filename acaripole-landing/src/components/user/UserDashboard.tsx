            ...
            <div style={{ background: C.white, border: `1px solid ${C.border}`, borderRadius: 12, padding: 32, boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                <div style={{ width: 40, height: 40, borderRadius: 12, background: 'rgba(59,130,246,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <Calendar size={20} color={C.goldLight} />
                </div>
                <h3 style={{ fontFamily: FONT_BODONI, fontSize: 20, margin: 0, color: C.text }}>Tu Próxima Consulta</h3>
              </div>
              <p style={{ color: C.textMedium, fontSize: 15, marginBottom: 32, lineHeight: 1.5 }}>
                Aún no tienes consultas programadas. Agenda tu primera consulta y comienza tu seguimiento en MEDIS.
              </p>
            ...
            <div style={{ background: C.white, border: `1px solid ${C.border}`, borderRadius: 12, padding: 32, boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
              ...
              <div style={{ background: C.bgPanel, border: `1px dashed ${C.border}`, borderRadius: 8, height: 300, display: 'flex', alignItems: 'center', justifyContent: 'center', color: C.textMedium }}>
                <div style={{ textAlign: 'center' }}>
                  ...
                  El horario se cargará aquí cuando agendes consultas.
                </div>
              </div>
