# ============================================================
#  deploy-acari.ps1  —  AcariPole deployment en GCP
#  VM: cuidame-app | IP: 35.239.162.75 | Proyecto: esmart-health
#
#  USO:
#    .\deploy-acari.ps1
#    .\deploy-acari.ps1 -DbPass "OtraPass!" -SkipUpload
# ============================================================
...
if (-not $JwtSecret) {
    $JwtSecret = "acari-jwt-$(Get-Random -Maximum 999999)-$(Get-Random -Maximum 9999)-prod"
}
...
function Invoke-RemoteBash {
    ...
    $base = "acari_$(Get-Date -Format 'HHmmss_fff')"
