...
export default function ArtistLogin({
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await response.json()
      if (!response.ok || !data.success) throw new Error(data.error || 'No se pudo completar el registro')
      localStorage.setItem('accessToken', data.data.tokens.accessToken)
      localStorage.setItem('refreshToken', data.data.tokens.refreshToken)
      ...
      <div style={{ flex: 1, background: `linear-gradient(146deg, ${C.brand} 0%, ${C.brandSecondary} 100%)`, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 24px' }}>
        ...
        >
          ...
          <div style={{ width: 450, flexShrink: 0, padding: '64px', background: C.white, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <form onSubmit={(e) => (mode === 'login' ? handleSubmit(e) : handleRegisterSubmit(e))} style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                ...
                <>
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      <span style={{ fontSize: 12, color: C.textMedium, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.09em' }}>Nombre</span>
                    </div>
                    <input
                      type="text"
                      required
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span style={{ fontSize: 14, color: C.textMedium, fontWeight: 400 }}>👤</span>
                      <span style={{ fontSize: 12, color: C.textMedium, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.09em' }}>Apellido</span>
                    </div>
                    <input
                      type="text"
                      required
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span style={{ fontSize: 14, color: C.textMedium, fontWeight: 400 }}>📞</span>
                      <span style={{ fontSize: 12, color: C.textMedium, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.09em' }}>Teléfono</span>
                    </div>
                    <input
                      type="tel"
                      required
